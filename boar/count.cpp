...
namespace boar
{
    ...
    static void DumpFileStat(const fs::path fileName)
    {
        ...
        {
            double estLineCount = info.avgLineSize == 0 ? 1.0 : (size / (sizeof(CharT) * info.avgLineSize));
